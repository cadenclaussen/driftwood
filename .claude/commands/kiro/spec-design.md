...
## Prerequisites
Check that `docs/.specs/requirements.md` exists. If not, guide user through the workflow.

## Workflow

1. Read `docs/.specs/prd.md` and `docs/.specs/requirements.md`
...
4. Generate `docs/.specs/design.md`

## Output Format for `docs/.specs/design.md`
...
5. Address all requirements from `docs/.specs/requirements.md`
