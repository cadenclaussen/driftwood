...
## Prerequisites
Check that `docs/.specs/tasks.md` exists. If not, guide user through the workflow.

## Workflow

1. Read all spec files to understand the full context
2. Read `docs/.specs/tasks.md` to get the task list
...
2. **Update Task Status**
   - Mark task as "In Progress" in `docs/.specs/tasks.md`

3. **Implement**
   - Follow the design in `docs/.specs/design.md`
...
5. **Update Status**
   - Mark task as "Completed" in `docs/.specs/tasks.md`
...
Update `docs/.specs/tasks.md` as you work:
