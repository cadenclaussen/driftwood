...
## Prerequisites
Check that `docs/.specs/prd.md` exists. If not, instruct user to run `/kiro:spec-init` first.

## Workflow

1. Read `docs/.specs/prd.md` to understand the feature scope
2. Analyze the existing codebase for context (patterns, conventions, related features)
3. Generate structured requirements in `docs/.specs/requirements.md`
...
## Output Format for `docs/.specs/requirements.md`
